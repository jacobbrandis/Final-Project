...
# on acceleration https://www.khanacademy.org/science/physics/one-dimensional-motion/kinematic-formulas/v/average-velocity-for
...
class BadPow(Sprite):
    def __init__(self, game, plat):
        ...
        self._layer = POW_LAYER
        # add a groups property where we can pass all instances of this object into game groups
        self.groups = game.all_sprites, game.badpowerup
        Sprite.__init__(self, self.groups)
        self.game = game
        self.plat = plat
